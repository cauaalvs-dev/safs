    ...
    <section id="galeria" style={{ padding: "100px 0", background: "white" }}>
      <div className="section-inner" style={{ maxWidth: 1152, margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 18 }} className="galeria-grid">
          {fotos.map((foto) => (
            <div key={foto.src} className="foto-card" style={{ borderRadius: 18, overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.09)", position: "relative", height: 230 }}>
              <Image src={foto.src} alt={foto.alt} fill style={{ objectFit: "cover" }} />
            </div>
          ))}
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: 52 }}>
          <a
            href="https://www.instagram.com/safs.dom.jose/"
            target="_blank"
