...
export default function Galeria() {
  return (
    <section id="galeria" style={{ padding: "96px 0", background: "white" }}>
      <style>{`
        .foto-card { transition: transform 0.2s, box-shadow 0.2s; }
        .foto-card:hover { transform: scale(1.03); box-shadow: 0 12px 32px rgba(0,0,0,0.18) !important; }
        .nav-link:hover { color: #3aaea9 !important; }
      `}</style>
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          <span style={{ color: "#3aaea9", fontWeight: 700, fontSize: 13, letterSpacing: "0.15em", textTransform: "uppercase" }}>Momentos</span>
          <h2 style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 900, color: "#1a2e35", margin: "8px 0 8px" }}>Nossa Galeria</h2>
          <p style={{ color: "#555f63", maxWidth: 480, margin: "0 auto", lineHeight: 1.7 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {fotos.map((f, i) => (
            <div key={i} className="foto-card" style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 16px rgba(0,0,0,0.1)", position: "relative", height: 220 }}>
