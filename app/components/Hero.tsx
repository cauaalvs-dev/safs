...
export default function Hero() {
  return (
    ...
    >
      {/* Círculos decorativos — purely visual, pointer-events off */}
      ...
      <div
        className="hero-grid"
        style={{ maxWidth: 1152, margin: "0 auto", padding: "130px 40px 90px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}
      >
        {/* Texto */}
        <div className="anim-fade-up">
          <span style={{
            ...
            textTransform: "uppercase", padding: "8px 20px", borderRadius: 999, marginBottom: 32,
            border: "1px solid rgba(255,255,255,0.2)",
          }}>
            Desde 18 de Janeiro de 1983 — Sobral, CE
          </span>

          <h1 style={{ color: "white", fontSize: "clamp(2.6rem, 5vw, 3.8rem)", fontWeight: 900, lineHeight: 1.12, marginBottom: 28, letterSpacing: "-0.01em" }}>
            Transformando<br />
            <span style={{ color: "#7fdbd8" }}>vidas</span> e<br />
            construindo futuros
          </h1>

          <p style={{ color: "rgba(255,255,255,0.78)", fontSize: 17, lineHeight: 1.85, marginBottom: 44, maxWidth: 460 }}>
          ...
          {/* Stats */}
          <div style={{ display: "flex", gap: 0, marginTop: 60, paddingTop: 36, borderTop: "1px solid rgba(255,255,255,0.15)" }}>
            {[
              ...
              <div key={s.label} style={{
                ...
                <div style={{ fontSize: "2.2rem", fontWeight: 900, color: "#7fdbd8", fontFamily: "Montserrat, sans-serif", lineHeight: 1 }}>{s.num}</div>
        ...
        <div className="anim-fade-in delay-300" style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
          ...
          <div style={{ position: "relative", width: 310, height: 310, borderRadius: "50%", overflow: "hidden", border: "5px solid rgba(255,255,255,0.22)", boxShadow: "0 32px 80px rgba(0,0,0,0.3)" }}>
            <Image
              ...
              alt="Família atendida pela SAFS no bairro Dom José"
              fill
          ...
          <div className="anim-fade-in delay-500" style={{
            ...
            <div style={{ position: "relative", width: 34, height: 40, flexShrink: 0 }}>
              <Image src="/images/logo-viver.png" alt="" aria-hidden="true" fill style={{ objectFit: "contain" }} />
            </div>
            <div>
      ...
      <style>{`
        @media (max-width: 900px) {
          .hero-grid { grid-template-columns: 1fr !important; gap: 48px !important; padding: 110px 24px 70px !important; }
