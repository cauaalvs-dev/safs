...
export default function Footer() {
  return (
    <footer style={{ background: "#1a2e35", color: "white", padding: "64px 0 32px" }}>
      <style>{`
        .footer-link { color: rgba(255,255,255,0.5); font-size:14px; text-decoration:none; transition:color 0.2s; display:block; }
        .footer-link:hover { color:#7fdbd8; }
        .footer-text { color: rgba(255,255,255,0.5); font-size:14px; display:block; margin:0; }
      `}</style>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 56, marginBottom: 56 }} className="footer-grid">
          <div>
            <div style={{ position: "relative", width: 58, height: 68, marginBottom: 20 }}>
              <Image src="/images/logo-safs-novo.png" alt="SAFS – Sociedade de Apoio à Família Sobralense" fill style={{ objectFit: "contain" }} />
            </div>
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 14, lineHeight: 1.8, maxWidth: 300, margin: 0 }}>
          ...
          <div>
            ...
            <address style={{ fontStyle: "normal", display: "flex", flexDirection: "column", gap: 12 }}>
              <p className="footer-text">Bairro Dom José, Sobral – CE</p>
